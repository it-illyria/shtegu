...
const en: Dictionary = {
  ...
  // Map
  trailhead: "Trailhead",
  trailStartLabel: "START",
  trailEndLabel: "FINISH",
  footerDiscoverHead: "Discover",
  footerCommunityHead: "Community",
  footerAboutHead: "About",
  footerAboutMission: "Mission",
  footerAboutSources: "Data sources",
  footerEmergencyTag: "Emergency",
  footerEmergencyTitle: "Dial 112",
  footerEmergencyHint: "General emergency number across Albania. Coverage may be limited in remote valleys.",
  footerOpenSource: "Built on open data — OpenStreetMap, Open-Meteo, Protomaps.",
