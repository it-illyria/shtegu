...
const sq: Dictionary = {
  ...
  footerDiscoverHead: "Zbulo",
  footerCommunityHead: "Komuniteti",
  footerAboutHead: "Rreth nesh",
  footerAboutMission: "Misioni",
  footerAboutSources: "Burimet e të dhënave",
  footerEmergencyTag: "Emergjencë",
  footerEmergencyTitle: "Telefononi 112",
  footerEmergencyHint: "Numri i përgjithshëm i emergjencave në Shqipëri. Mbulimi mund të jetë i kufizuar në lugina të largëta.",
  footerOpenSource: "I ndërtuar mbi të dhëna të hapura — OpenStreetMap, Open-Meteo, Protomaps.",
  planYourAdventure: "Planifiko aventurën",
